...
def getcommon(data1, data2):
    return list(set(data1) & set(data2))

result = 0

for datum in data:
    rucksacks = getrucksacks(datum)
    rucksack1 = maprucksack(rucksacks[0])
    rucksack2 = maprucksack(rucksacks[1])
    result += sum(getcommon(rucksack1, rucksack2))
    print(result)
